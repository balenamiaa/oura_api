...
defmodule OuraApi.Connection do
  @moduledoc """
  Handle Tesla connections for OuraApi.

  Additional middleware can be set in the compile-time or runtime configuration:

      config :tesla, OuraApi.Connection,
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:oura_api, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - OuraApi 2.0 - elixir"
        )
      )
